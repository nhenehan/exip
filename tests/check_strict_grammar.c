 ...
 * @version 0.5
 * @par[Revision] $Id: check_strict_grammar.c 360 2015-04-19 19:44:06Z kjussakov $
 */
...
static String ENUM_DATA_QUALITY[] = {
    {"Good", 4},
...
static String ENUM_DATA_VAL_TYPE[] = {
    {"Bool", 4},
    {"Long", 4}};
