...
IF( NOT CHECK_FOUND )
	IF ( CHECK_INSTALL_DIR )
		...
		IF(Win32)
		MESSAGE ( STATUS "Detect Win32 using ${CHECK_INSTALL_DIR} to find libs" )
		FIND_LIBRARY( CHECK_LIBRARY NAMES check PATHS "${CHECK_INSTALL_DIR}" )
		FIND_LIBRARY( COMPAT_LIBRARY NAMES compat PATHS "${CHECK_INSTALL_DIR}" )
		ELSE(Win32)
